...
const CASOS = [
  ...
  { nome: '#155 variações e maionese à parte',
    ...
    checar: (l) => [
      ...
      ['maionese à parte cobra sachê', soma(l, 'sache_maionese') >= 1],
    ] },
  ...
  { nome: '#158 maionese à parte é sachê', texto: 'Sao 2 e um maionese a oarte', carrinho: [['x_tudo', 1], ['xeggbacon', 2]],
    checar: (l) => [['1 sachê', soma(l, 'sache_maionese') === 1]] },
  { nome: '"Add maionese" (dono, 18/09)', texto: 'Add maionese', carrinho: [['x_tudo', 2]],
    checar: (l) => [['1 sachê', soma(l, 'sache_maionese') === 1], ['nada dentro do lanche', !l.itens.some((i) => i.com.includes('maionese'))]] },
