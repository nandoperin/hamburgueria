...
// pede outro (o bot registra um novo assim que o anterior expira). Trinta
// minutos: o QR desenhado no log sai quebrado, então o link é o único caminho
// para parear, e ele precisa sobreviver ao atraso do log e à espera entre as
// tentativas de conexão (dono, 19 e 20/09). Some assim que o bot conecta
// (`encerrar`), e sem QR pendente não mostra nada.
